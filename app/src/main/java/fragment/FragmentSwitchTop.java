 ...
 */
public class FragmentSwitchTop extends FragmentSwitch {
    /**
     ...
     */
    public static FragmentSwitchTop newInstance() {
        Bundle args = new Bundle();

        FragmentSwitchTop fragment = new FragmentSwitchTop();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getTextView().setText(SWITCH_TOP);
    }
     ...
     */
    @Override
    protected String getTargetFragmentType() {return SWITCH_BTM;}
}
